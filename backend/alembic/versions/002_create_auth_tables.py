...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_recovery_tokens_deleted_at")
    op.execute("DROP INDEX IF EXISTS ix_recovery_tokens_token_hash")
    op.execute("DROP INDEX IF EXISTS ix_recovery_tokens_auth_identity_id")
    op.execute("DROP INDEX IF EXISTS ix_recovery_tokens_tenant_id")
    op.execute("DROP TABLE IF EXISTS password_recovery_tokens CASCADE")

    op.execute("DROP INDEX IF EXISTS ix_refresh_sessions_deleted_at")
    op.execute("DROP INDEX IF EXISTS ix_refresh_sessions_family_id")
    op.execute("DROP INDEX IF EXISTS ix_refresh_sessions_token_hash")
    op.execute("DROP INDEX IF EXISTS ix_refresh_sessions_auth_identity_id")
    op.execute("DROP INDEX IF EXISTS ix_refresh_sessions_tenant_id")
    op.execute("DROP TABLE IF EXISTS refresh_sessions CASCADE")

    op.execute("DROP INDEX IF EXISTS ix_auth_identities_deleted_at")
    op.execute("DROP INDEX IF EXISTS ix_auth_identities_email_hash")
    op.execute("DROP INDEX IF EXISTS ix_auth_identities_tenant_id")
