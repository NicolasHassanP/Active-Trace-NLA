## Purpose
Endpoint y repositorio para consulta paginada del historial de comunicaciones enviadas por el usuario autenticado, con filtro de estado, índice de BD y aislamiento multi-tenant.
