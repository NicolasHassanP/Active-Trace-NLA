...
### 1.1 `encuentros-coord` envía días en formato inválido
...
### 1.2 Dos errores de TypeScript pre-existentes
...
### 2.1 Teardown de fixtures incompatible con la inmutabilidad de `audit_event`
...
### 4.3 Permiso `guardias:registrar` sin uso
